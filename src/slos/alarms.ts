...
export class SLOAlarms extends Construct {
   ...
   */
  public static apiAvailabilityAlarm = (
   ...
   */
  public static appSyncLatencyAlarm = (
    sloWindow: IAlertConfig,
    scope: Construct,
    slo: AnySLO,
    alarmName: string,
   ...
   */
  public static customLatencyAlarm = (
    sloWindow: IAlertConfig,
    scope: Construct,
    slo: AnySLO,
    alarmName: string,
   ...
   */
  public static createCompositeAlarm = (childAlarms: Alarm[][]): string => {
  ...
  ): { severity: string, parentAlarm: CfnCompositeAlarm, childAlarms: Alarm[][] }[] => {
  ...
  constructor(scope: Construct, id: string, props: ISLOAlarmsProps) {
    ...
    let alarmDescription = 'Service is at risk of exceeding its error budget. '
      + 'Please use the links below to troubleshoot the problem:'
