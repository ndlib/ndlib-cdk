...
export class StaticHost extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, props: IStaticHostProps) {
    ...
    this.logBucket = props.logBucket || new Bucket(this, 'LogBucket', {
    ...
    props.edgeLambdas?.forEach(edgeLambda => {
      edgeLambda.function.addToRolePolicy(new PolicyStatement({
      ...
      originConfigs: [
        {
          ...
          behaviors: (props.edgeLambdas && props.edgeLambdas.length)
